...
Network.obfuscate = function (network_pdu) {
    obfuscated = "";
    iv_index = utils.toHex(db.data.IVindex, 4);
    obfuscated = crypto.obfuscate(network_pdu.EncDST, network_pdu.EncTransportPDU, network_pdu.NetMIC, ctl, ttl, utils.toHex(seq, 3), src, iv_index, Selected_NetKey.PrivacyKey);
    return obfuscated;
};
